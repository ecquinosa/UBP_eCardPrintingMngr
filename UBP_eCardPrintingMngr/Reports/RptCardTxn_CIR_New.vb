...
Public Class RptCardTxn_CIR_New
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UBP_eCardPrintingMngr.RptCardTxn_CIR_New.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCardTxn_CIR_New
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCardTxn_CIR_New = New RptCardTxn_CIR_New()
        rpt.Site = Me.Site
        Return rpt
    End Function
