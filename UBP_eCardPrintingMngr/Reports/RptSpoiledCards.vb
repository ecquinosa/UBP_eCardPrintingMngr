...
Public Class RptSpoiledCards
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UBP_eCardPrintingMngr.RptSpoiledCards.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSpoiledCards
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSpoiledCards = New RptSpoiledCards()
        rpt.Site = Me.Site
        Return rpt
    End Function
