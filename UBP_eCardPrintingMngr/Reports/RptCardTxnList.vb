...
Public Class RptCardTxnList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UBP_eCardPrintingMngr.RptCardTxnList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCardTxnList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCardTxnList = New RptCardTxnList()
        rpt.Site = Me.Site
        Return rpt
    End Function
